-- Replaces debug function to use pg_policies view (accessible without superuser),
-- and still reports RLS status via pg_class. Safe to run multiple times.
